...
<style>
  ...
  /* Warm cream backdrop for the How-RxKids-would-work section (replaces the
     cool blue-grey). The white step/banner cards and the green $15M pill still
     read clearly on it; the connector line between steps is warmed to a soft
     amber so it doesn't clash with the cream. */
